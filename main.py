...
# IMPORTANT: Set TELEGRAM_TOKEN and OPENAI_API_KEY as environment variables in Render.
import os
import sqlite3
import json
import logging
...
logger = logging.getLogger("telebot-render")

TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN")
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")
OPENAI_MODEL = os.getenv("OPENAI_MODEL", "gpt-3.5-turbo")
DATABASE_PATH = os.getenv("DATABASE_PATH", "data.db")
BASE_URL = os.getenv("BASE_URL")  # set to https://your-service.onrender.com after deploy
ADMIN_IDS_ENV = os.getenv("ADMIN_IDS")
DEFAULT_ADMIN = 761662415

if not TELEGRAM_TOKEN or not OPENAI_API_KEY:
    logger.warning("TELEGRAM_TOKEN or OPENAI_API_KEY is not set. App will start but won't respond to Telegram until secrets are provided.")
